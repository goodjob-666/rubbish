<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True" CodeBehind="default.aspx.cs" Inherits="FrameWork.web.Module.FrameWork.EventPhonePwdManager._default"  %>
<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server" HeadOPTxt="手密修改日志" HeadTitleTxt="手密修改日志" ButtonList-Capacity="4">
    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="手密修改日志">
		...
		<tr style="display:none">
            ...
            <tr>
                ...
                <asp:TextBox ID="E_Record" runat="server" CssClass="text_input" style="width:180px"></asp:TextBox>
                    </td>
                <td class="table_body table_body_NoWidth" style="height: 28px">
                    时间</td>
                <td class="table_none table_none_NoWidth" style="height: 28px">
            ...
            <tr>
                ...
                <asp:DropDownList ID="ddlType" runat="server">
                    <asp:ListItem Value="无限制">无限制</asp:ListItem>
                    <asp:ListItem Value="置空手机">置空手机</asp:ListItem>
                    <asp:ListItem Value="修改密保">修改密保</asp:ListItem>
                    <asp:ListItem Value="登录密码">登录密码</asp:ListItem>
                    <asp:ListItem Value="证明资料">证明资料</asp:ListItem>
                    </asp:DropDownList>
                    </td>
            </tr>
            <tr style="display:none">
