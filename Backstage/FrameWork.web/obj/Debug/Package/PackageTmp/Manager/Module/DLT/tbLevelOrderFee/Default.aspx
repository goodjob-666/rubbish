<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="Default.aspx.cs" Inherits="DLT.Web.Module.DLT.tbLevelOrderFee.Default"
    Title="无标题页" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
         HeadOPTxt="订单费用列表" HeadTitleTxt="订单费用">
    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="订单费用列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="金额" SortExpression="Bal" DataField="Bal" />
                    <asp:BoundField HeaderText="手续费" SortExpression="Fee" DataField="Fee" />
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="Bal_Input" title="请输入金额~float" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="Fee_Input" title="请输入手续费~float" runat="server" CssClass="text_input"></asp:TextBox>
