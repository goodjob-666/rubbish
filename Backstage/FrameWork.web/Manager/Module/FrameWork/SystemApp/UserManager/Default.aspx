                    ...
                    <asp:TemplateField SortExpression="U_Status" HeaderText="用户状态">
                        <ItemTemplate>
                            <%#GetStat((int)Eval("U_Status"))%>
                                        ...
                                        <asp:TemplateField SortExpression="U_FirstCheck" HeaderText="是否首查">
                        <ItemTemplate>
                         <asp:CheckBox ID="cbIsDeal" runat="server" OnCheckedChanged="cbIsDeal_CheckedChanged" AutoPostBack="true" ValidationGroup='<%#Eval("UserID")%>' />（勾选即生效）
                         <asp:HiddenField ID="hfIsDeal" runat="server" Value='<%#Eval("U_FirstCheck")%>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            </asp:GridView>
        ...
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem2" runat="server" Tab_Name="查询">
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                <tr>
                    ...
                    <td class="table_body table_body_NoWidth">
                        中文名</td><td class="table_none table_none_NoWidth">
                        <asp:TextBox ID="U_CName" runat="server" CssClass="text_input"></asp:TextBox></td><td class="table_body table_body_NoWidth">
                        员工编号</td><td class="table_none table_none_NoWidth">
                        <asp:TextBox ID="U_UserNO" runat="server" CssClass="text_input"></asp:TextBox></td></tr><tr>
                    <td class="table_body table_body_NoWidth">
                        用户类型</td><td class="table_none table_none_NoWidth">
                        <asp:DropDownList ID="U_Type" runat="server">
                            <asp:ListItem Value="">不限</asp:ListItem><asp:ListItem Value="1">普通用户</asp:ListItem><asp:ListItem Value="2">管理员</asp:ListItem><asp:ListItem Value="0">超级用户</asp:ListItem></asp:DropDownList></td><td class="table_body table_body_NoWidth">
                        用户状态</td><td class="table_none table_none_NoWidth">
                        <asp:DropDownList ID="U_Status" runat="server">
                            <asp:ListItem Value="">不限</asp:ListItem><asp:ListItem Value="0">正常</asp:ListItem><asp:ListItem Value="1">禁止</asp:ListItem></asp:DropDownList></td></tr><tr>
