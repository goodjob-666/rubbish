<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="Default.aspx.cs" Inherits="DLT.Web.Module.DLT.tsMember.Default"
    Title="无标题页" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
         HeadOPTxt="用户成员列表" HeadTitleTxt="用户成员">
    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="用户成员列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="用户分组ID" SortExpression="GroupID" DataField="GroupID" />
                    <asp:BoundField HeaderText="用户ID" SortExpression="UserID" DataField="UserID" />
                    <asp:BoundField HeaderText="成员用户" SortExpression="MemberUserID" DataField="MemberUserID" />
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="GroupID_Input" title="请输入用户分组ID~2147483648:int" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="MemberUserID_Input" title="请输入成员用户~2147483648:int" runat="server" CssClass="text_input"></asp:TextBox>
