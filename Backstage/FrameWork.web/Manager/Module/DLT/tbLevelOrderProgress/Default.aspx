<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="Default.aspx.cs" Inherits="DLT.Web.Module.DLT.tbLevelOrderProgress.Default"
    Title="无标题页" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
         HeadOPTxt="代练进度列表" HeadTitleTxt="代练进度">
    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="代练进度列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="图片地址" SortExpression="Img" DataField="Img" />
                    <asp:BoundField HeaderText="描述" SortExpression="Comment" DataField="Comment" />
                    <asp:BoundField HeaderText="进度来源" SortExpression="Source" DataField="Source" />
                </Columns>
            </asp:GridView>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="Img_Input" title="请输入图片地址~256:" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="Source_Input" title="请输入进度来源~32767:int" runat="server" CssClass="text_input"></asp:TextBox>
