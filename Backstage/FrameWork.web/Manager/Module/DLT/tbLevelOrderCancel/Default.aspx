<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="Default.aspx.cs" Inherits="DLT.Web.Module.DLT.tbLevelOrderCancel.Default"
    Title="无标题页" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
         HeadOPTxt="代练撤销列表" HeadTitleTxt="代练撤销">
    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="代练撤销列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="支付代练费" SortExpression="PayLevelBal" DataField="PayLevelBal" />
                    <asp:BoundField HeaderText="赔偿保证金" SortExpression="RepEnsureBal" DataField="RepEnsureBal" />
                    <asp:BoundField HeaderText="状态" SortExpression="Status" DataField="Status" />
                    <asp:BoundField HeaderText="备注" SortExpression="Comment" DataField="Comment" />
                    <asp:BoundField HeaderText="接单方撤销次数" SortExpression="AcceptCount" DataField="AcceptCount" />
                    <asp:BoundField HeaderText="发单方撤销次数" SortExpression="PublishCount" DataField="PublishCount" />
                </Columns>
            </asp:GridView>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="PayLevelBal_Input" title="请输入支付代练费~float" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="RepEnsureBal_Input" title="请输入赔偿保证金~float" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="Status_Input" title="请输入状态~32767:int" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="AcceptCount_Input" title="请输入接单方撤销次数~2147483648:int" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="PublishCount_Input" title="请输入发单方撤销次数~2147483648:int" runat="server" CssClass="text_input"></asp:TextBox>
