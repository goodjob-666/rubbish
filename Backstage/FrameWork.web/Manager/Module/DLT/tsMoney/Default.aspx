<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="Default.aspx.cs" Inherits="DLT.Web.Module.DLT.tsMoney.Default"
    Title="无标题页" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
         HeadOPTxt="余额列表" HeadTitleTxt="余额">
    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="余额列表">
            <asp:GridView ID="GridView1" runat="server" OnSorting="GridView1_Sorting" OnRowCreated="GridView1_RowCreated" >
                <Columns>
                    ...
                    <asp:BoundField HeaderText="总金额" SortExpression="SumBal" DataField="SumBal" />
                    <asp:BoundField HeaderText="冻结资金" SortExpression="FreezeBal" DataField="FreezeBal" />
                    <asp:BoundField HeaderText="变动日期" SortExpression="ChangeDate" DataField="ChangeDate" />
                </Columns>
            </asp:GridView>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="SumBal_Input" title="请输入总金额~float" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="FreezeBal_Input" title="请输入冻结资金~float" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="ChangeDate_Input" title="请输入变动日期~datetime" runat="server" CssClass="text_input"></asp:TextBox>
