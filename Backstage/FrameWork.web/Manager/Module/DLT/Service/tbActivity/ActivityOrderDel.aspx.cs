...
{
    public partial class ActivityOrderDel : System.Web.UI.Page
    {
        string ActivityID = "";
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < Checkbox_Value_Array.Length; i++)
            {
                ...
                if (IDX != "")
                {
                    DataSet ds = BusinessFacadeDLT.OrderActivityReturn(IDX);
                }
            }

            Response.Write("<script language='javascript'>alert('订单还原进活动成功！');window.parent.ld(0);</script>");
