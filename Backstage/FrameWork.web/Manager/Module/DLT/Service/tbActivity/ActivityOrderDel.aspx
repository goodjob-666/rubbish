<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActivityOrderDel.aspx.cs" Inherits="FrameWork.web.Manager.Module.DLT.Service.tbActivity.ActivityOrderDel" %>
...
<body>
    ...
    <div>
      ...
      <asp:Button ID="Button3" CssClass="button_bak" runat="server" Text="还原" OnClientClick="return deleteop();" OnClick="Button3_Click" /> 
