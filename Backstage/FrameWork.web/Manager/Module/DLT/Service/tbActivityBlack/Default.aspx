<%@ Page Language="C#" MasterPageFile="~/Manager/MasterPage/PageTemplate.Master" AutoEventWireup="True"
    Codebehind="Default.aspx.cs" Inherits="DLT.Web.Module.DLT.tbActivityBlack.Default"
    Title="无标题页" %>

<asp:Content ID="Content1" ContentPlaceHolderID="PageBody" runat="server">
    <FrameWorkWebControls:HeadMenuWebControls ID="HeadMenuWebControls1" runat="server"
         HeadOPTxt="平台活动黑名单列表" HeadTitleTxt="平台活动黑名单列表">
    ...
    <FrameWorkWebControls:TabOptionWebControls ID="TabOptionWebControls1" runat="server">
        <FrameWorkWebControls:TabOptionItem ID="TabOptionItem1" runat="server" Tab_Name="平台活动黑名单列表">
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="3" align="center">
                <tr>
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="UserID_Input" title="请输入用户ID~24:" runat="server" CssClass="text_input"></asp:TextBox>
                ...
                <tr  style="display:none">
                    ...
                    <td class="table_none">
                        ...
                        <asp:TextBox ID="Comment_Input" title="请输入Comment~512:" runat="server" CssClass="text_input"></asp:TextBox>
