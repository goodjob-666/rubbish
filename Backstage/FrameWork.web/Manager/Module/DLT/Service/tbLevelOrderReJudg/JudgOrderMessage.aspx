<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JudgOrderMessage.aspx.cs" Inherits="DLT.Web.Module.DLT.tbLevelOrderReJudg.JudgOrderMessage" %>
    ...
    <div style="margin-top:10px;">
        ...
        <div style="margin-right: 5px;float:right;">
          <asp:LinkButton ID="LinkButton5" runat="server" BackColor="White" BorderColor="Red"
                ForeColor="DarkGreen" Visible="false" OnClick="LinkButton5_Click">刷新</asp:LinkButton>
        </div>
      </div>
      <br />
