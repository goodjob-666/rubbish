...
namespace FrameWork.Components
{
    ...
    public class sys_UserTable
    {
        ...
        private int _U_SGroupID = 0;  // 部门ID号与sys_Group表中GroupID关联
        private int _U_FirstCheck = 1;
        #endregion
        ...
        public int U_SGroupID
        {
            set { this._U_SGroupID = value; }
            get { return this._U_SGroupID; }
        }
        ...
        /// 首查(为空系统认证,其它值为其它认证)
        /// </summary>
        public int U_FirstCheck
        {
            set { this._U_FirstCheck = value; }
            get { return this._U_FirstCheck; }
        }
