...
namespace FrameWork
{
    ...
    public class Image1
    {
        ...
        /// 以图片中心为轴心，截取正方型，然后等比缩放  
        /// </summary>
        /// <param name="fromFile">文件流</param>
        /// <param name="side">裁剪大小</param>
        /// <param name="quality">压缩质量</param>
        /// <returns></returns>
        public static System.Drawing.Image CutForSquare(System.IO.Stream fromFile, int side, int quality)
        {
            //原始图片（获取原始图片创建对象，并使用流中嵌入的颜色管理信息）  
            System.Drawing.Image initImage = System.Drawing.Image.FromStream(fromFile, true);
        ...
        {
            if (contentType == "image/pjpeg" || contentType == "image/jpeg" || contentType == "image/gif" || contentType == "image/bmp" || contentType == "image/png" || contentType == "image/jpg")
            {
                return true;
            }
            else
