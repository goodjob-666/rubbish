...
namespace FrameWork.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        protected object Populatesys_User(IDataReader dr)
        {
            ...
            if (!Convert.IsDBNull(dr["U_SGroupID"])) nc.U_SGroupID = Convert.ToInt32(dr["U_SGroupID"]); // 部门ID号与sys_Group表中GroupID关联
            if (!Convert.IsDBNull(dr["U_FirstCheck"])) nc.U_FirstCheck = Convert.ToInt32(dr["U_FirstCheck"]); // 是否首查
            return nc;
        }
        #endregion
